...
RSpec.describe 'Users::Registrations', type: :request do
  ...
  # TODO: let!(:space_headers) { { 'Host' => "space.#{Settings['base_domain']}" } }
  ...
  describe 'POST /users' do
    ...
    shared_examples_for 'OK' do
      it '作成される' do
        expect do
          post user_registration_path, params: { user: attributes }, headers: base_headers
  ...
  describe 'PUT /users' do
    ...
    shared_examples_for 'OK' do
      it '名前が変更される' do
        put user_registration_path, params: { user: attributes.merge(current_password: current_password) }, headers: base_headers
  ...
  describe 'PUT /users/image' do
    ...
    shared_examples_for 'OK' do
      it '画像が変更される' do
        put users_image_path, params: { user: attributes }, headers: base_headers
  ...
  describe 'DELETE /users/image' do
    ...
    shared_examples_for 'OK' do
      it '画像が削除される' do
        delete users_image_path, headers: base_headers
  ...
  describe 'DELETE /users/undo_delete' do
    ...
    shared_examples_for 'OK' do
      it '削除依頼日時が空に変更される' do
        delete users_undo_delete_path, headers: base_headers
