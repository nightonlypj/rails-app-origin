...
RSpec.describe 'Users::Registrations', type: :request do
  ...
  # GET /users/sign_up（ベースドメイン） アカウント登録
  # 前提条件
  #   なし
  # テストパターン
  ...
  # POST /users/sign_up（ベースドメイン） アカウント登録(処理)
  # 前提条件
  #   なし
  # テストパターン
  #   未ログイン, ログイン中, ログイン中（削除予約済み） → データ＆状態作成
  ...
  describe 'POST #create' do
    ...
    shared_examples_for 'OK' do
      it '作成される' do
        expect do
          post create_user_registration_path, params: { user: attributes }, headers: headers
  ...
  # PUT(PATCH) /users/edit（ベースドメイン） 登録情報変更(処理)
  # 前提条件
  #   なし
  # テストパターン
  #   未ログイン, ログイン中, ログイン中（削除予約済み） → データ＆状態作成
  ...
  describe 'PUT #update' do
    ...
    shared_examples_for 'OK' do
      it '氏名が変更される' do
        put update_user_registration_path, params: { user: attributes.merge(current_password: current_password) }, headers: headers
  ...
  # PUT(PATCH) /users/image（ベースドメイン） 画像変更(処理)
  # 前提条件
  #   なし
  # テストパターン
  #   未ログイン, ログイン中, ログイン中（削除予約済み） → データ＆状態作成
  ...
  describe 'PUT #image_update' do
    ...
    shared_examples_for 'OK' do
      it '画像が変更される' do
        put update_user_image_registration_path, params: { user: attributes }, headers: headers
  ...
  # DELETE /users/image（ベースドメイン） 画像削除(処理)
  # 前提条件
  #   なし
  # テストパターン
  #   未ログイン, ログイン中, ログイン中（削除予約済み） → データ＆状態作成
  ...
  describe 'DELETE #image_destroy' do
    ...
    shared_examples_for 'OK' do
      it '画像が削除される' do
        delete delete_user_image_registration_path, headers: headers
  ...
  # GET /users/delete（ベースドメイン） アカウント削除
  # 前提条件
  #   なし
  # テストパターン
  #   未ログイン, ログイン中, ログイン中（削除予約済み） → データ＆状態作成
  ...
  describe 'GET #delete' do
    ...
    shared_examples_for 'ToOK' do
      it '成功ステータス' do
        get delete_user_registration_path, headers: headers
        expect(response).to be_successful
      end
    end
    shared_examples_for 'ToTop' do |alert, notice|
    ...
    shared_examples_for 'ToBase' do |alert, notice|
      it 'ベースドメインにリダイレクト' do
        get delete_user_registration_path, headers: headers
        expect(response).to redirect_to("//#{Settings['base_domain']}#{delete_user_registration_path}")
        expect(flash[:alert]).to alert.present? ? eq(I18n.t(alert)) : be_nil
        expect(flash[:notice]).to notice.present? ? eq(I18n.t(notice)) : be_nil
      end
    end
  ...
  # DELETE /users/delete（ベースドメイン） アカウント削除(処理)
  # 前提条件
  #   なし
  # テストパターン
  #   未ログイン, ログイン中, ログイン中（削除予約済み） → データ＆状態作成
  ...
  describe 'DELETE #destroy' do
    ...
    shared_examples_for 'OK' do
      ...
      it '削除依頼日時が現在日時に変更される' do
        delete destroy_user_registration_path, headers: headers
  ...
  # GET /users/undo_delete（ベースドメイン） アカウント削除取り消し
  # 前提条件
  #   なし
  # テストパターン
  #   未ログイン, ログイン中, ログイン中（削除予約済み） → データ＆状態作成
  ...
  describe 'GET #undo_delete' do
    ...
    shared_examples_for 'ToOK' do
      it '成功ステータス' do
        get delete_undo_user_registration_path, headers: headers
        expect(response).to be_successful
      end
    end
    shared_examples_for 'ToTop' do |alert, notice|
    ...
    shared_examples_for 'ToBase' do |alert, notice|
      it 'ベースドメインにリダイレクト' do
        get delete_undo_user_registration_path, headers: headers
        expect(response).to redirect_to("//#{Settings['base_domain']}#{delete_undo_user_registration_path}")
        expect(flash[:alert]).to alert.present? ? eq(I18n.t(alert)) : be_nil
        expect(flash[:notice]).to notice.present? ? eq(I18n.t(notice)) : be_nil
      end
    end
  ...
  # DELETE /users/undo_delete（ベースドメイン） アカウント削除取り消し(処理)
  # 前提条件
  #   なし
  # テストパターン
  #   未ログイン, ログイン中, ログイン中（削除予約済み） → データ＆状態作成
  ...
  describe 'DELETE #undo_destroy' do
    ...
    shared_examples_for 'OK' do
      it '削除依頼日時がなしに変更される' do
        delete destroy_undo_user_registration_path, headers: headers
