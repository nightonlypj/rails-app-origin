...
RSpec.describe 'Users::Passwords', type: :request do
  ...
  describe 'POST /users/password' do
    ...
    shared_examples_for 'ToOK' do
      it '成功ステータス' do
        post user_password_path, params: { user: attributes }, headers: base_headers
        expect(response).to be_successful
      end
    end
    shared_examples_for 'ToTop' do
  ...
  describe 'PUT /users/password' do
    ...
    shared_examples_for 'OK' do
      it 'パスワードリセット送信日時が空に変更される' do
        put user_password_path, params: { user: attributes.merge({ reset_password_token: token }) }, headers: base_headers
