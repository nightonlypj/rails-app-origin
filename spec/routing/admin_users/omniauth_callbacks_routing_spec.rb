...
RSpec.describe AdminUsers::OmniauthCallbacksController, type: :routing do
  describe 'routing' do
    it 'routes to #passthru' do
      ...
      # expect(get: '/admin/auth/twitter').not_to be_routable # NOTE: rails_admin/main#show
      expect(post: '/admin/auth/twitter').not_to be_routable
    end
    it 'routes to #failure' do
      ...
      expect(get: '/admin/auth/twitter/callback').not_to be_routable
      expect(post: '/admin/auth/twitter/callback').not_to be_routable
    end
  end
end
