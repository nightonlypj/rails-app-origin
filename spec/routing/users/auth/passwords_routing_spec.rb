...
RSpec.describe Users::Auth::PasswordsController, type: :routing do
  describe 'routing' do
    ...
    it 'routes to #new' do
      expect(post: '/users/auth/password').to route_to('users/auth/passwords#create', format: :json)
    ...
    it 'routes to #update' do
      ...
      expect(put: '/users/auth/password/update').to route_to('users/auth/passwords#update', format: :json)
      expect(patch: '/users/auth/password/update').to route_to('users/auth/passwords#update', format: :json)
