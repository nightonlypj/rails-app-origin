...
RSpec.describe MembersController, type: :routing do
  describe 'routing' do
    ...
    it 'routes to #create' do
      ...
      expect(post: '/members/c1').to route_to('members#create', customer_code: 'c1')
    end
    it 'routes to #update via PUT' do
      expect(put: '/members/1').not_to be_routable
      expect(put: '/members/c1/u1').to route_to('members#update', customer_code: 'c1', user_code: 'u1')
    end
    it 'routes to #update via PATCH' do
      expect(patch: '/members/1').not_to be_routable
      expect(patch: '/members/c1/u1').to route_to('members#update', customer_code: 'c1', user_code: 'u1')
    end
    ...
    it 'routes to #destroy' do
      ...
      expect(delete: '/members/c1/u1').to route_to('members#destroy', customer_code: 'c1', user_code: 'u1')
    end
  end
end
